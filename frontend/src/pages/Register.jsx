                ...
                <form onSubmit={handleRegister} className="space-y-6">
                  ...
                  <div>
                    <button
                      type="submit"
                      disabled={loading}
                      className={`w-full px-8 py-3 ${loading ? 'bg-gray-400' : 'bg-red-500 hover:bg-red-600'} text-white rounded-md transition-colors`}
                    >
                ...
                <form onSubmit={handleVerifyOTP} className="space-y-6">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      OTP expires in <span className="text-red-500 font-medium">{formatTime(timeLeft)}</span>
                    </p>
                  </div>
                  ...
                  <div>
                    <button
                      ...
                      className={`w-full px-8 py-3 ${loading || otp.length < 4 ? 'bg-gray-400' : 'bg-red-500 hover:bg-red-600'} text-white rounded-md transition-colors`}
                    >
